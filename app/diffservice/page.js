...
import {
  ...
  AiOutlineBarChart,
  AiOutlineGlobal,
} from "react-icons/ai"; // Using react-icons for better design
      ...
      <header className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-lg max-w-2xl mx-auto">
            At Micro-Sonic, we bring innovation, precision, and creativity to every printing solution. Explore our services and experience printing like never before.
          </p>
        </div>
      </header>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold mb-6">
            Experience the Micro-Sonic Difference
          </h2>
